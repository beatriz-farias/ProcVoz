...
startRecordButton.addEventListener('click', async () => {
    try {
        if(!permission_stream){
            permission_stream = await navigator.mediaDevices.getUserMedia({ audio: true });
        }
        mediaRecorder = new MediaRecorder(permission_stream);
...
// Essa parte a seguir é relacionada ao estilo do jogo
document.addEventListener('DOMContentLoaded', () => {
...
//Essa parte é referente ao botão de inicio de jogo que faz o jogo começar depois das instrucoes
